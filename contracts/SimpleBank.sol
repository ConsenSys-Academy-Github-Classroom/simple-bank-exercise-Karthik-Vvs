...
contract SimpleBank {
    ...
    function deposit() public payable returns (uint) {
      ...
      require(enrolled[msg.sender], "user not enrolled! Reverting..");
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
      ...
      require(balances[msg.sender] >= withdrawAmount,"Do not have enough funds to withdraw. Please enter a valid withdraw amount");
